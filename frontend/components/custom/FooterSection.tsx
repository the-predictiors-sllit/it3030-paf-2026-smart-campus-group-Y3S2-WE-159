    ...
    return (
        <footer className="py-10 md:py-10">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mb-8 mt-2 flex flex-wrap justify-center gap-6 text-lg text-muted-foreground">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {2026} Smart Campus, All rights reserved</span>
            </div>
        </footer>
    )
}